 ...
 *******************************************************************************/
package hu.blackbelt.emfbuildergenerator.tests;
...
import hu.blackbelt.emfbuildergenerator.EMFBuilderGenerator;
import hu.blackbelt.emfbuildergenerator.tests.lazyBuilder.A;
import hu.blackbelt.emfbuildergenerator.tests.lazyBuilder.util.builder.ABuilder;
import hu.blackbelt.emfbuildergenerator.tests.lazyBuilder.util.builder.BBuilder;
...
public class EMFBuilderGeneratorTest {
	...
	public void callsReferencedBuilderLazy() {
		BBuilder bBuilder = BBuilder.create();
		ABuilder aBuilder = ABuilder.create().withB(bBuilder);
	...
	@Test
	@Ignore("TODO: Platform resource make tycho compatible")
	public void testIssue6_MoreThanOnePackage() throws IOException {
		...
		emfBuilderGenerator.setEcoreURI(URI.createPlatformResourceURI("/emfbuildergenerator-tests/model/issue6.ecore", true).toString());
		emfBuilderGenerator.addGenModelUri(URI.createPlatformResourceURI("/emfbuildergenerator-tests/model/issue6.genmodel", true).toString());
