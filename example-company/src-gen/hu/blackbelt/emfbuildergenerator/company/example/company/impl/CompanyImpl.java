/**
 */
package hu.blackbelt.emfbuildergenerator.company.example.company.impl;

import hu.blackbelt.emfbuildergenerator.company.example.company.Company;
import hu.blackbelt.emfbuildergenerator.company.example.company.CompanyPackage;
import hu.blackbelt.emfbuildergenerator.company.example.company.Department;
 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.emfbuildergenerator.company.example.company.impl.CompanyImpl#getName <em>Name</em>}</li>
 *   <li>{@link hu.blackbelt.emfbuildergenerator.company.example.company.impl.CompanyImpl#getDepartment <em>Department</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompanyImpl extends EObjectImpl implements Company {
	...
	public EList<Department> getDepartment() {
		if (department == null) {
			department = new EObjectContainmentEList<Department>(Department.class, this, CompanyPackage.COMPANY__DEPARTMENT);
		}
		return department;
	}
